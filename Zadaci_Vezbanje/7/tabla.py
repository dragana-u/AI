...
class Squares(Problem):
    ...
    def h(self, node):
        kvadratcinja = list(node.state)
        krajna = list(self.goal)
        kv1 = abs(kvadratcinja[0][0] - krajna[0][0]) + abs(kvadratcinja[0][1] - krajna[0][1])
        kv2 = abs(kvadratcinja[1][0] - krajna[1][0]) + abs(kvadratcinja[1][1] - krajna[1][1])
        kv3 = abs(kvadratcinja[2][0] - krajna[2][0]) + abs(kvadratcinja[2][1] - krajna[2][1])
        kv4 = abs(kvadratcinja[3][0] - kvadratcinja[3][0]) + abs(kvadratcinja[3][1] - krajna[3][1])
