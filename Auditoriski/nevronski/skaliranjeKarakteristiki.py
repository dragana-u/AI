...
from kvalitetVino import read_dataset, divide_sets
...
if __name__ == '__main__':
    ...
    print(f'Bez normalizacija imame tocnost so validacisko m-vo od {val_acc1}')
    ...
    print(f'So standardna normalizacija imame tocnost so val m-vo od {val_acc2}')
    ...
    print(f'So min-max skaliranje imame tocnost so val m-vo od {val_acc3}')
